    ...
    try {
        ...
        parser.visit(ast, {
            ...
            FunctionCall: (node) => {
                ...
                else if ((exprAny.type === 'FunctionCallOptions' || exprAny.type === 'NameValueExpression') &&
                    exprAny.expression &&
                ...
                if (node.body) {
                    ...
                    parser.visit(node.body, {
                        ...
                        FunctionCall: (callNode) => {
                            ...
                            const callExprAny = callNode.expression;
                            ...
                            else if ((callExprAny.type === 'FunctionCallOptions' || callExprAny.type === 'NameValueExpression') &&
                        ...
                        ExpressionStatement: (exprNode) => {
                            ...
                            else if ((expr.type === 'UnaryOperation' && ['++', '--'].includes(expr.operator)) ||
