...
/** Uniswap v4 educational CounterHook — Continuity (self-contained for browser solc). */
export const uniswapV4CounterHook: ContractTemplate = {
  id: 'uniswap-v4-counter-hook',
  name: 'Uniswap v4 CounterHook',
  description: 'Educational v4-style before/afterSwap counter hook (IDE Continuity)',
  code: `// SPDX-License-Identifier: MIT
...
contract CounterHook {
    ...
    /// @notice IDE Continuity helper — bump counter without PoolManager auth (not for production pools).
