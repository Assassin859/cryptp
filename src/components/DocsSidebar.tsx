...
const DocsSidebar: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'integrations' | 'guide'>('integrations');

  return (
    <div className="flex flex-col h-full bg-[#252526] font-sans overflow-hidden">
      {/* Tabs */}
      <div className="flex border-b border-[#3c3c3c] bg-[#1e1e1f] shrink-0">
        <button
          onClick={() => setActiveTab('integrations')}
          className={`flex-1 py-2 text-[10px] font-black uppercase tracking-widest text-center transition-colors border-b-2 ${
